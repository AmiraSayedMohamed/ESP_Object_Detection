...
def run_object_detection():
    global message_count  # Keep track of detected objects
    ...
    try:
        while True:
            ...
            for bbox, confi, cls in zip(bboxes, confidences, classes):
                ...
                if object_name.lower() == 'infected':  # Example: Change condition based on class names
                    message_count += 1
...
def run_face_detection():
    global message_count  # Keep track of detected faces
